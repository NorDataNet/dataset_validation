...
class ComplianceChecker implements ComplianceCheckerInterface {
  ...
  public function checkCompliance(string $filepath, string $filename, string $test): bool {
    ...
    // } else { $bin_path = ''; }.
    // Linux.
    $venv_python = '/home/ubuntu/python-venv/bin/python3';
    $script = '/home/ubuntu/python-venv/bin/compliance-checker';
    ...
    $out = NULL;
    $status = NULL;
    exec($command . ' -v -c lenient -f html -o - --test=' . $test . ' ' . $filepath, $out, $status);
